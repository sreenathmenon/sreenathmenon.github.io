...
"clear_cache_help" =>
"Optionally clear the cache when saving variable values.",
...
"Choose if variables can be parsed early in the parsing order; before or after existing Snippets and config-variables.",
