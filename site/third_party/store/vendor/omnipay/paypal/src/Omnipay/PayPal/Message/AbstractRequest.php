...
abstract class AbstractRequest extends \Omnipay\Common\Message\AbstractRequest
{
    ...
    //Added by Sreenath for adding the condition for confirmed shipping address
    public function getReqConfShipping() {
        return $this->getParameter('reqConfShipping');
    }

    //Added by Sreenath for adding the condition for confirmed shipping address
    public function setReqConfShipping() {
        return $this->setParameter('reqConfShipping', $value);
    }
