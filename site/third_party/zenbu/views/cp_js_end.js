...
<?php if(isset($edit_replace)) :?>
	...
	*/
	...
	// Replacement in EE 2.8+
	$("a[href*=\"/cp/content_edit\"][class!=z_comment_link]").each(function (){
		$(this).attr("href", $(this).attr("href").replace(/content_edit\?/, "addons_modules/show_module_cp?module=zenbu&"));
	});
