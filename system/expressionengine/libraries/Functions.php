...
class EE_Functions {
	...
	function create_captcha($old_word = '', $force_word = FALSE)
	{
		...
		$expiration = 60*60*2;  // 2 hours
                ...
                //Modified by Sreenath
		$img_width	= 110;	// Image width
		...
		ImageJPEG($im, $img_path.$img_name);
                ...
                //modified by Sreenath
                $img = "<img src=\"$img_url$img_name\" width=\"$img_width\" height=\"$img_height\" style=\"border:0; float:left; margin-left:24%; \" alt=\" \" />";	
